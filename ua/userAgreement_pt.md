...
Estes Termos de Uso (doravante denominados "Termos") estabelecem as condições para utilização do Paper Leaf (doravante denominado "Aplicativo"), fornecido por Yuki Ishino (doravante denominado "Nós"). Ao utilizar este Aplicativo, você concorda com estes Termos.
