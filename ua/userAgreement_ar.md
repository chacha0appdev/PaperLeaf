...
تحدد شروط الاستخدام هذه (المشار إليها فيما بعد بـ "الشروط") شروط استخدام تطبيق Paper Leaf (المشار إليه فيما بعد بـ "التطبيق")، والذي تقدمه Yuki Ishino (المشار إليه فيما بعد بـ "نحن"). باستخدام هذا التطبيق، يُعتبر أنك قد وافقت على هذه الشروط.
